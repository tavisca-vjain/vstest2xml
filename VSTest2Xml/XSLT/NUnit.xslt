  ...
  <xsl:template match="/">
    ...
    <xsl:element name="test-results">
      ...
      <xsl:attribute name="date">
        <xsl:value-of select="substring-before(t:TestRun/t:Times/@start,'T')"/>
      </xsl:attribute>

      <!-- invalid -->
      <xsl:attribute name="invalid">
        <xsl:value-of select="t:TestRun/t:ResultSummary/t:Counters/@notRunnable"/>
      </xsl:attribute>
      ...
      <xsl:element name="environment">
        ...
        <!-- machine-name -->
        <xsl:attribute name="machine-name">
        ...
        <xsl:element name="results">
          ...
          <xsl:for-each select="t:TestRun/t:TestDefinitions/t:UnitTest">
            ...
            <xsl:element name="test-case">
              ...
              <!-- name="" -->
              <xsl:attribute name="name">
                <xsl:value-of select="t:TestMethod/@className"/>.<xsl:value-of select="@name"></xsl:value-of>
              </xsl:attribute>
